...
public class Weather {
	    ...
	    public String weather() throws Exception {
	    	...
	    	String baseDate = "20201214"; //조회하고싶은 날짜
	      ...
	      //JSONArray를 사용하여 배열형식의 데이터를 읽어온다.
	        ...
	        /*
	        System.out.println("발표일자: "+(String) t.get("baseDate"));
	        System.out.println("발표시각: "+(String) t.get("baseTime"));
	        System.out.println("예측일자: "+(String) t.get("fcstDate"));
	        System.out.println("예측시간: "+(String) t.get("fcstTime"));
	        System.out.println("예보지역 좌표 (x,y): "+ "("+t.get("nx")+", "+ t.get("ny")+")");
	        System.out.println();
	        */
